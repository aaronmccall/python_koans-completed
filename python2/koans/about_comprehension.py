...
class AboutComprehension(Koan):
    ...
    def test_filtering_lists_with_list_comprehensions(self):
        ...
        self.assertEqual(len(filter(lambda x: len(x) > 6, feast)), len(comprehension))
    ...
    def test_creating_a_dictionary_with_dictionary_comprehension(self):
        ...
        self.assertEqual(len(dict_of_weapons.keys()), len(dict_of_weapons))
        self.assertEqual(len(filter(lambda x: x, dict_comprehension.values())), len(dict_comprehension))
